...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <br/>   
        <iframe style="width:82%;height:500px;border-top: 3px solid #3c8dbc;border-left:none" src="<?php echo base_url(); ?>admin/propriedades/<?= $this->uri->segment(2) == 'cadastrar'?$nextIdPropriedade->id:$id ?>" title="" ></iframe>
    </section>
</div>
