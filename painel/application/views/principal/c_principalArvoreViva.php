...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <br/>   
        <iframe style="width:82%;height:800px;border-top: 3px solid #3c8dbc;border-left:none;margin-bottom:100px" src="<?php echo base_url(); ?>admin/arvoresvivas/<?= $this->uri->segment(2) == 'cadastrar'?$nextIdArvoreViva->id:$id ?>" title="" ></iframe>
    </section>
</div>
